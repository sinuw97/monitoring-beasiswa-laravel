...
<div id="{{ $modalId }}" class="fixed inset-0 z-50 bg-gray-900/50 flex items-center justify-center p-4 hidden">
    <div class="bg-white rounded-lg shadow-xl max-w-sm w-full m-4 overflow-hidden transform transition-all">
        <div class="flex justify-between items-center p-4 border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-800">Tambah Periode Baru</h3>
        ...
        <form action="{{ $action }}" method="POST">
            ...
            <div class="p-4 space-y-3">
                <p class="text-sm text-gray-600 mb-2">Periode akademik baru akan dibuat secara otomatis berdasarkan data
                    terakhir. Silakan masukkan tanggal mulai dan selesai.</p>
                <div class="text-sm">
