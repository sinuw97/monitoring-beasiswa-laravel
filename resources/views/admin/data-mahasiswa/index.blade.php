                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="{{ route('admin.data-mahasiswa.destroy', $mhs->nim) }}" method="POST" class="inline-block" onsubmit="return showConfirmationModal(event, 'Apakah Anda yakin ingin menghapus data mahasiswa {{ $mhs->nim }}?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
