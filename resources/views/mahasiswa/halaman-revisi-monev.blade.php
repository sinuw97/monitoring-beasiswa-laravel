...
@section('content')
    <div class="mb-8">
        <h1 class="font-bold text-3xl text-gray-900 tracking-tight">Revisi Laporan Monev</h1>
        <p class="text-gray-500 mt-2 text-lg">Perbaiki laporan monitoring evaluasi Anda sesuai masukan dosen.</p>
    </div>
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-700">
                    Laporan ini <span class="font-bold">DIKEMBALIKAN</span>. Silakan perbaiki data sesuai catatan dari Dosen Pembimbing Akademik.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                <div x-cloak x-data="{ openReports: false, openEditReports: false, editDataReports: {} }"
                    ...
                    <div class="flex justify-between items-center mb-4 pb-2 border-b border-gray-100">
                        ...
                        @if ($laporan->status === 'Dikembalikan' || $laporan->status === 'Revisi')
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                @if ($laporan->status === 'Dikembalikan' || $laporan->status === 'Revisi')
                    ...
                    {{-- Modal Edit --}}
                    <x-modal title="Edit Data Kegiatan Penugasan dan Kepanitian" show="openEditCommittee">
                        <form method="POST" enctype="multipart/form-data"
                        ...
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tipe-prestasi" id="tipe-prestasi" required
                                    class="w-full border rounded px-2 py-1 focus:outline-none focus:ring-0">
                                    <option value="" class="italic">Pilih Tipe</option>
                                    <option value="Kompetisi Pemerintahan Individu">Kompetisi Pemerintahan Individu</option>
                                    <option value="Kompetisi Pemerintahan Kelompok">Kompetisi Pemerintahan Kelompok</option>
                                    <option value="Kompetisi Non-Pemerintahan Individu">Kompetisi Non-Pemerintahan Individu</option>
                                    <option value="Kompetisi Non-Pemerintahan Kelompok">Kompetisi Non-Pemerintahan Kelompok</option>
                                    <option value="Juri/Wasit/Pelatih">Menjadi Juri/Wasit/Pelatih</option>
                                    <option value="Anggota Dalam Penelitian/Pengabdian">Anggota Dalam Penelitian/Pengabdian</option>
                                    ...
                                    <option value="Karya Populer Yang Diterbitkan">Menghasilkan Karya Populer Yang Diterbitkan</option>
                                    <option value="Penulis Buku ISBN">Penulis Buku ISBN</option>
                                    <option value="Paten/Paten Sederhana">Paten/Paten Sederhana</option>
                                    <option value="Publikasi Jurnal Internasional/Nasional">Publikasi Jurnal Internasional/Nasional Bereputasi</option>
                                    <option value="Ikut Kegiatan Sosial/Kerohanian Mewakili Institusi">Mengikuti Kegiatan di Bidang Sosial/Kerohanian yang mewakili institusi di luar Perguruan Tinggi</option>
                                    <option value="Lomba Mewakili Insititusi">Mengikuti Lomba mewakili institusi di luar Perguruan Tinggi</option>
                                    <option value="Pelatihan Keterampilan Di Luar PT">Pelatihan Keterampilan Di luar PT</option>
                                    <option value="Pengakuan Dari Institusi Lain">Pengakuan Dari Institusi Lain</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tingkat" id="tingkat-prestasi" required
                                    ...
                                    <option value="Regional Tidak Terakreditasi">Regional Tidak Terakreditasi</option>
                                </select>
                            </div>
                            <div class="mb-3">
            ...
            <div x-cloak x-data="{ openEvaluation: false, openEditEvaluation: false, editDataEvaluation: {} }"
                class="bg-white rounded-xl shadow-md border border-gray-100 p-6 mb-6">

                <div class="flex justify-between items-center mb-4 pb-2 border-b border-gray-100">
                    <h3 class="text-xl font-bold text-gray-800">C. Evaluasi Diri</h3>

                    @if ($laporan->status === 'Dikembalikan' || $laporan->status === 'Revisi')
                        @if ($parsingEvaluations)
                            {{-- Data sudah ada → tombol Edit --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <p class="text-[#013F4E] text-lg font-semibold mb-2">Faktor Pendukung</p>
                        <div class="p-4 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 min-h-[150px]">
                            {{ $parsingEvaluations->support_factors ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <p class="text-[#013F4E] text-lg font-semibold mb-2">Faktor Penghambat</p>
                        <div class="p-4 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 min-h-[150px]">
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                {{-- 3. Rencana Prestasi --}}
                <div x-cloak x-data="{ openTargetAchievement: false, openEditTargetAchievement: false, editDatatargetAchievement: {} }"
                ...
                <div x-cloak x-data="{ openTargetIndependent: false, openEditTargetIndependent: false, editDataTargetIndependent: {} }"
            ...
            <div x-cloak x-data="{ openKeuangan: false, openEditKeuangan: false, editDataKeuangan: {} }"
                ...
                <div class="flex justify-between items-center mb-4 pb-2 border-b border-gray-100">
                    <h3 class="text-xl font-bold text-gray-800">E. Laporan Keuangan</h3>
                    @if ($laporan->status === 'Dikembalikan' || $laporan->status === 'Revisi')
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-xl lg:text-2xl font-bold text-[#013F4E]">
                                Rp {{ $parsingLaporanKeuangan ? number_format($parsingLaporanKeuangan['total'], 0, ',', '.') : 0 }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                @if ($laporan->status === 'Dikembalikan' || $laporan->status === 'Revisi')
                    ...
                    {{-- Modal Edit --}}
                    <x-modal title="Edit Data Keuangan Mahasiswa" show="openEditKeuangan">
                        <form method="POST"
            ...
            <div x-cloak x-data="{ openKesanPesan: false, openEditKesanPesan: false, editDataKesanPesan: {} }"
                ...
                <div class="flex justify-between items-center mb-4 pb-2 border-b border-gray-100">
                    <h3 class="text-xl font-bold text-gray-800">F. Kesan dan Pesan Mahasiswa</h3>
                    @if ($laporan->status === 'Dikembalikan' || $laporan->status === 'Revisi')
                ...
                @if ($laporan->status === 'Dikembalikan' || $laporan->status === 'Revisi')
                    {{-- Modal tambah --}}
                    <x-modal title="Tambah Data Kesan dan Pesan" show="openKesanPesan">
                    ...
                    {{-- Modal Edit --}}
                    <x-modal title="Edit Data Kesan dan Pesan" show="openEditKesanPesan">
                        <form method="POST"
            ...
            <x-modal title="Konfirmasi Pengajuan Revisi Laporan" show="openModalKonfirmasi">
                ...
                <div class="flex items-center justify-center gap-5">
                    ...
                    <form action="{{ route('laporan.ajukan', $laporan->laporan_id) }}" method="POST"
                        ...
                        @method('PUT')
                        <button type="submit" x-bind:disabled="submitting"
                            x-text="submitting ? 'Mengirim...' : 'Konfirmasi'"
                            :class="submitting ? 'cursor-not-allowed bg-gray-400' : 'cursor-pointer bg-[#09697E] hover:bg-[#075363]'"
                            class="px-3 py-1 text-white rounded transition shadow-sm font-medium">
                        </button>
                    </form>
                </div>
            </x-modal>
